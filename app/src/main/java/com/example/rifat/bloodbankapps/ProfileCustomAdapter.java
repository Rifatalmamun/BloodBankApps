...
public class ProfileCustomAdapter extends ArrayAdapter<DonorClass>  {
    ...
    public ProfileCustomAdapter(Activity context, List<DonorClass> donorList) {
        super(context, R.layout.profile_result_sample_layout,donorList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.profile_result_sample_layout,null,true);

        DonorClass donorClass = donorList.get(position);


        TextView Name=view.findViewById(R.id.profileDonorNameTextViwsample_id);
        TextView BloodGroup=view.findViewById(R.id.profileDonorBloodGroupTextViwsample_id);
        TextView District=view.findViewById(R.id.profileDonorDistrictTextViwsample_id);

        TextView PhoneNumber=view.findViewById(R.id.profileDonorPhoneNumberTextViwsample_id);
        ...
        TextView Department=view.findViewById(R.id.profileDonorDepartmentsample_id);
        TextView Session=view.findViewById(R.id.profileDonorSessionsample_id);
        TextView LastDonationDate=view.findViewById(R.id.profileDonorLastDonationsample_id);
       ...
       // EmailAddress.setText("Email: "+donorClass.getDonor_email());
        ...
        /*ImageView PhoneIcon=view.findViewById(R.id.profileDonorPhoneIcon_id);
        ImageView EmailIcon=view.findViewById(R.id.profileDonorEmailIcon_id);
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.profileDonorPhoneIcon_id){
            alertMethod("Are you really want to call?","1");
        }
        if(v.getId()==R.id.profileDonorEmailIcon_id){
