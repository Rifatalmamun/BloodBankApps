...
public class districtListAlertDialogBloodBank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_district_list_alert_dialog_blood_bank);
        ...
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(districtListAlertDialogBloodBank.this,R.layout.currentlocationsamplelistview,R.id.currentLocationSampleTextView_id,cityName);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!value.isEmpty()){
                    ...
                    Intent intent = new Intent(districtListAlertDialogBloodBank.this,AddBloodBankActivity.class);
