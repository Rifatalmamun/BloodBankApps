...
public class SessionList extends AppCompatActivity {
    ...
    public String catchName,catchBloodGroup,catchPhone,catchDist,catchDepart,catchLastDate,catchkeY,catchRanD,catchParentBG,catchParentDis,catchParentPHN,catchPassword;
